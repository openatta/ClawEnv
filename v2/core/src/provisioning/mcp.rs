...
const BRIDGE_MJS: &str = include_str!("../../../assets/mcp/mcp-bridge.mjs");
const HIL_MJS: &str = include_str!("../../../assets/mcp/hil-skill.mjs");
const HW_MJS: &str = include_str!("../../../assets/mcp/hw-notify.mjs");
const BRIDGE_PY: &str = include_str!("../../../assets/mcp/mcp-bridge.py");
const HIL_PY: &str = include_str!("../../../assets/mcp/hil-skill.py");
const HW_PY: &str = include_str!("../../../assets/mcp/hw-notify.py");
